var config = {/* 前后端通信相关的配置,注释只允许使用多行方式 */
    /* 上传图片配置项 */
...
var uploadConfig = {
    image: {
        type: 'image',
        allowType: config.imageAllowFiles,
        fileKey: config.imagePathFormat,
        maxSize: config.imageMaxSize
    },
    file: {
        type: 'file',
        allowType: config.fileAllowFiles,
        fileKey: config.filePathFormat,
        maxSize: config.fileMaxSize
    },
    video: {
        type: 'video',
        allowType: config.videoAllowFiles,
        fileKey: config.videoPathFormat,
        maxSize: config.videoMaxSize
    },
    scraw: {
        type: 'scraw',
        allowType: config.scrawlAllowFiles,
        fileKey: config.scrawlPathFormat,
        maxSize: config.scrawlMaxSize
    },
    fetch: {
        type: 'fetch',
        allowType: config.catcherAllowFiles,
        fileKey: config.catcherPathFormat,
        maxSize: config.catcherMaxSize
    }
};

// 配置参数
exports.ueditorOptions = {
    actions: {
